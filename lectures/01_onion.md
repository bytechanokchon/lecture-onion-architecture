...
### Value Object
คือออปเจ็คที่เก็บค่า ๆ หนึ่งไว้พร้อมกับกฏทางธุรกิจ
...
จากชุดคำสั่งดังกล่าว ทำให้กฏทางธุรกิจที่เอาไว้จัดการกับจำนวนเงิน ไม่กระจัดกระจายไปตาม service ต่าง ๆ เพราะมีการบังคับกฏทางธุรกิจเอาไว้ใน Value Object นี้แล้ว
...
### Domain Service
จะจัดเก็บภาพรวมของ business logic ทั้งหมด เช่น การโอนเงิน จะต้องโอนจากใคร ไปหาใคร จำนวนเท่าไหร่ จะต้องตรวจสอบอะไรบ้าง แต่จะไม่มีการเรียกใช้งานของที่อยู่ใน infrastructure เช่น ส่งอีเมล
...
กระบวนการหลัก (Process/Flow) ที่ระบบต้องทำเพื่อให้บรลุเป้าหมายของโดเมนนั้น
